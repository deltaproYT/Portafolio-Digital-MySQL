...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
SELECT COUNT(age), age FROM users WHERE age < 30 GROUP BY age ORDER BY age DESC; -- Selecciona los datos de la columna 'age' cuyos valores son menores a 30, los agrupa por sus valores unicos, ubica las cantidades de repeticiones y los ordena de forma descendente --
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

-- HAVING --
SELECT COUNT(age) FROM users HAVING COUNT(age) > 3; -- NO SE --
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

-- CASE --
SELECT *,                               --                                                                      --
CASE                                    --  Crea un condicional                                                 --
WHEN age >= 18 THEN 'Mayor de Edad'     --  Que crea una columna con el nombre "adulthood", si edad >= 18,      --
ELSE 'Menor de Edad'                    --  asigna un string "Mayor de Edad" y en cualquier otro caso asigna    --
END AS adulthood                        --  un string "Menor de Edad"                                           --
FROM users;                             --                                                                      --
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
SELECT *,                                   --                                                                      --
CASE                                        --  Crea un condicional                                                 --
WHEN age > 18 THEN 'Mayor de Edad'          --  Que crea una columna con el nombre "adulthood", si edad > 18,       --
WHEN age = 18 THEN 'Recien Mayor de Edad'   --  asigna un string "Mayor de Edad", si edad = 18 asigna un string     --
ELSE 'Menor de Edad'                        --  "Recien Mayor de Edad" y en cualquier otro caso asigna              --
END AS adulthood                            --  un string "Menor de Edad"                                           --
FROM users;                                 --                                                                      --
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

-- IFNULL --
SELECT IFNULL(email, 'NaN') FROM users; -- Crea una columna basada en la columna 'age' donde los valores nulos se reemplazan por el texto 'Nan' --
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
SELECT IFNULL(email, 'NaN') AS email FROM users; -- Crea una columna basada en la columna 'age' con el alias de 'age' donde los valores nulos se reemplazan por el texto 'Nan' --
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------